                ...
                <table class="table m-0">
                    <thead>
                        <tr>
                            <?
                            // tallas
                            $tallas = mysqli_query($con,"select * from tcattallas where idtalla in (select idtalla from tproductoexistencias where idproducto='".$producto["idproducto"]."' and idalmacen='".$idalmacen."' group by idtalla) order by posicion");
                    ...
                    <tbody>
                        <tr>
                            ...
                            while ($talla = mysqli_fetch_assoc($tallas)) {
                                $precio = $producto["precio"] + mysqli_fetch_assoc(mysqli_query($con,"select * from tproductovariantesprecio where idproducto='".$producto["idproducto"]."' and idtalla='".$talla["idtalla"]."'"))["variante"];
                                ?>
                                <td>
