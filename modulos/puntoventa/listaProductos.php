...
if ($_POST["accion"]=="agregar") {
    // if (mysqli_num_rows(mysqli_query($con,"select * from trticketproductostmp where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."' and idproducto='".$_POST["idproducto"]."'"))==0) {
        // mysqli_query($con,"insert into trticketproductostmp (idvendedor,idproducto,cantidad,descuento) values ('".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."','".$_POST["idproducto"]."',1,'".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3descuento"]."')");
        // mysqli_query($con,"insert into trcuentaproductostmp (idvendedor,idproducto,cantidad,descuento) values ('".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."','".$_POST["idproducto"]."',1,'".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3descuento"]."')");
    // } else {
    //     mysqli_query($con,"update trticketproductostmp set cantidad=cantidad+1 where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."' and idproducto='".$_POST["idproducto"]."'");
    // }
    $errortarjeta = false;
    if($_POST["codigo"]!=""){
        $query = "
    ...
    if(!$errortarjeta){
        if (mysqli_num_rows(mysqli_query($con,"select * from trcuentaproductostmp where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."' and idproducto='".$_POST["idproducto"]."' and idproducto in (select idproducto from tproductos where idproducto='".$_POST["idproducto"]."' and tipo='S')"))==0) {
            mysqli_query($con,"insert into trcuentaproductostmp (idvendedor,idproducto,idcolor,idtalla,cantidad,descuento,codigo) values ('".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."','".$_POST["idproducto"]."','".$_POST["idcolor"]."','".$_POST["idtalla"]."',1,'".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3descuento"]."','".$_POST["codigo"]."')");
        } else {
...
if ($_POST["accion"]=="asignarcantidad") {
    mysqli_query($con,"update trcuentaproductostmp set cantidad=".$_POST["cantidad"]." where idtmp='".$_POST["idpartida"]."'");
}

if ($_POST["accion"]=="sumar") {
    mysqli_query($con,"update trcuentaproductostmp set cantidad=cantidad+".$_POST["cantidad"]." where idtmp='".$_POST["idpartida"]."'");
}

if ($_POST["accion"]=="restar") {
    // if (mysqli_num_rows(mysqli_query($con,"select * from trticketproductostmp where idtmp='".$_POST["idpartida"]."' and cantidad=1"))>0) {
    //     mysqli_query($con,"delete from trticketproductostmp where idtmp='".$_POST["idpartida"]."'");
    // } else {
    //     mysqli_query($con,"update trticketproductostmp set cantidad=cantidad-1 where idtmp='".$_POST["idpartida"]."'");
    // }
...
if ($_POST["accion"]=="aplicardescuento") {
    // mysqli_query($con,"update trticketproductostmp set descuento='".$_POST["descuento"]."' where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."'");
...
if ($_POST["accion"]=="aplicardescuentoindividual") {
    // mysqli_query($con,"update trticketproductostmp set descuento='".$_POST["descuento"]."' where idtmp='".$_POST["idpartida"]."'");
...
if ($_POST["accion"]=="eliminarproductos") {
    // mysqli_query($con,"delete from trticketproductostmp where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."'");
...
// $partidas = mysqli_query($con,"select * from trticketproductostmp where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."'");
$partidas = mysqli_query($con,"select * from trcuentaproductostmp where idvendedor='".$_SESSION["v3nd3d0rpl4y3r4spvc1sn3usr"]."'");
            ...
            <table class="table m-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center"><a href="javascript:;" onClick="aplicarCantidad(<? echo $partida["idtmp"]; ?>);"><? echo $partida["cantidad"]; ?></a></td>

                        <!-- <td><? echo $producto["nombre"]; ?></td> -->
                        <td>
                            <div class="row">
                                <div class="col">
                                    <? echo $producto["nombre"] . ($partida["idcolor"]!=0 ? "<br>Color: " . $nombrecolor . "<br>Talla: " . $nombretalla : "").(($partida["codigo"]!="") ? "<br>Código: ".$partida["codigo"] : ""); ?>
                                </div>
                            </div>
                            <?
                                ...
                                <div class="row" id="divPersonalizacion<? echo $partida["idtmp"]; ?>" style="margin-top:15px;">
                                    <div class="col-4">
                                        <select name="slcTipoPersonalizado<? echo $partida["idtmp"]; ?>-<? echo $personalizacion["idtmp"]; ?>" id="slcTipoPersonalizado<? echo $partida["idtmp"]; ?>-<? echo $personalizacion["idtmp"]; ?>" class="form-control" onChange="actualizarSelect(<? echo $personalizacion["idtmp"]; ?>,this.value);">
                                            ...
                                            <?
                                            $categorias = mysqli_query($con,"select * from tcatpersonalizaciones where status = 1");
                        ...
                        <td align="right"><a href="javascript:;" onClick="restarProducto(<? echo $partida["idtmp"]; ?>);" class="btn btn-danger"><i class="fas fa-minus"></i></a></td>
                        <td align="right"><a href="javascript:;" onClick="asignarCantidad(<? echo $partida["idtmp"]; ?>,1,'sumar');" class="btn btn-primary"><i class="fas fa-plus"></i></a></td>
                        <td align="right">
                        <?
...
<? if($errortarjeta){ ?>
alert("ERROR: Esta tarjeta ya fue vendida anteriormente.");
<? } ?>
</script>
